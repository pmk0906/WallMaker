...
namespace basecross {
	...
	void GameStage10::CreateViewLight()
	{
		...
		m_CameraSelect = CameraSelect_Stage10::openingCamera;
		//マルチライトの作成
	...
	void GameStage10::CreateWall()
	{
		...
		const int mapData[] =
		{
			...
			001,047, 48, 48, 48, 48, 48, 49,001,000,000,000,001,047, 48, 48, 48, 48, 49,001,
			001,044,000,000,000,000,042,000,000,000,006,000,000,000,000,042,000,000,046,001,
			001,044,000,005,000,046,001,046,001,000,000,000,001,044,046,001,044,000,046,001,
			001,044,000,000,000,000, 48,   9,001,001,001,001,001,044,000, 48,000,000,046,001,
			001,076,000,000,000,000,000,000, 48, 48, 48, 48, 48,000,000,   9,000,000,046,001,
			001,044,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,074,001,
			001,044,000,000,042,000,000,000,042,000,000,005,000,000,042,000,000,000,046,001,
			001,044,000,046,001,044,000,046,001,044,000,000,000,046,001,044,000,000,046,001,
			001,044,003,000, 48,000,000,000, 48,000,000,000,000,000, 48,000,000,000,046,001,
			001,044,000,000,000,000,000,000,000,000,000,000,000,   9,000,000,042,000,046,001,
			001,076,000,000,000,042,000,000,000,000,042,000,000,000,000,046,001,044,046,001,
			001,044,000,000,046,001,044,000,000,046,001,044,000,000,000,000, 48,000,046,001,
			001,044,000,000,000, 48,000,000,005,000, 48,000,000,000,042,000,000,000,074,001,
			001,044,000,005,000,000,042,000,000,000,000,000,000,046,001,044,000,000,046,001,
			001,044,000,000,000,046,001,044,000,000,000,000,003,000, 48,000,000,000,046,001,
			001,076,000,000,000,000, 48,000,000,000,000,000,000,000,000,000,000,000,046,001,
			001,044,046,001,044,000,000,000,000,000,000,000,042,000,000,000,   9,000,046,001,
			001,044,000, 48,000,000,000,000,042,000,000,046,001,044,000,000,000,000,046,001,
			001,044,000,000,000,003,000,046,001,044,000,000, 48,000,000,042,000,000,046,001,
			001,044,000,000,000,000,000,000, 48,000,003,000,000,000,046,001,044,000,046,001,
			001,044,000,000,000,000,000,000,000,000,000,000,000,000,000, 48,000,000,046,001,
			001,044,000,000,042,000,000,042,042,042,042,042,000,042,000,000,000,000,046,001,
			001,044,000,046,001,044,046,001,001,001,001,001,442,001,044,000,000,000,046,001,
			001,044,000,000, 48,000,046,001,000,000,000,001,044, 48,000,000,003,000,046,001,
			001,044,000,000,000,000,000,000,000,002,000,000,000,000,000,000,000,000,046,001,
			001,041,042,042,042,042,043,001,000,000,000,001,041,042,042,042,042,042,043,001,
			001,001,001,001,001,001,001,001,001,001,001,001,001,001,001,001,001,001,001,001,
		};
		...
		for (int r = 0; r < mapRows; r++) {
			for (int c = 0; c < mapCols; c++) {
				...
				case 3: // 通常の敵
					...
					break;
				case 032: // 通常の敵
					AddGameObject<EnemyFirst>(Vec3(2.0f, 1.0f, 3.5f), Vec3(0.0f, XMConvertToRadians(180.0f), 0.0f), Vec3(pos));
					break;
				case 5: // 連射的
					AddGameObject<RapidFireEnemy>(Vec3(2.0f, 1.0f, 3.5f), Vec3(0.0f), Vec3(pos));
					break;
				case 052:
					AddGameObject<RapidFireEnemy>(Vec3(2.0f, 1.0f, 3.5f), Vec3(0.0f, XMConvertToRadians(180.0f), 0.0f), Vec3(pos));
					break;
					// 反射壁(テンキーの配置参照)
				case 041:
				...
				case 9:
					...
					break;
				case 92:
					AddGameObject<DangerEnemy>(Vec3(2.0f, 1.0f, 3.5f), Vec3(0.0f, XMConvertToRadians(180.0f), 0.0f), Vec3(pos));
					break;
				case 10:
	...
	void GameStage10::CreateStage()
	{
		...
		for (int l = 0; l < STAGE_LENGTH / 4; l++) {
			for (int w = 0; w < STAGE_WIDTH / 4; w++) {
				AddGameObject<Floor>(Vec3(12.0f, 1.0f, 12.0f), Vec3(0.0f), Vec3(w * 12 - STAGE_WIDTH + 4.0f, -0.5f, l * 12 - STAGE_LENGTH - 20.0f));
			}
		}
		//床一枚のみ
	...
	void GameStage10::CreatePlayer(Vec3 pos)
	{
	...
	//カメラマンの作成
	void GameStage10::CreateCameraman()
	{
		// オープニングカメラを登録
	...
	void GameStage10::CreateClearButton()
	{
		auto gm = GameManager::GetInstance();
		...
		auto buttonSprite2 = AddGameObject<ButtonSprite>(true, Vec2(600, 100), Vec2(0, -145.0f), true, 1.0f, L"STAGESELECT_BUTTON_TX", 0, 2, Col4(1, 1, 1, 0.5f));
		gm->SetMaxButtonNum(0);
		gm->SetSelectingButton(0);
	}

	void GameStage10::CreateGameOverButton()
	{
		auto gm = GameManager::GetInstance();
	...
	void GameStage10::CreateSpriteAndButton()
	{
	...
	void GameStage10::SwitchPoseButton(bool poseFlg)
	{
		auto gm = GameManager::GetInstance();
	...
	void GameStage10::StopBGM()
	{
		auto ptrXA = App::GetApp()->GetXAudio2Manager();
		ptrXA->Stop(m_BGM);
	}

	void GameStage10::ChangeBGM(wstring bgmKey)
	{
	...
	void GameStage10::SetBgmName(wstring bgmName)
	{
		m_BgmName = bgmName;
	}

	wstring GameStage10::GetBgmName()
	{
		return m_BgmName;
	}

	void GameStage10::ToMyCamera() {
		auto gm = GameManager::GetInstance();

		//MyCameraに変更
		if (m_CameraSelect == CameraSelect_Stage10::openingCamera)
		{
			...
			if (ptrMyCamera) {
				...
				m_CameraSelect = CameraSelect_Stage10::myCamera;
			}
		}
	}

	void GameStage10::ToPlayerCamera() {
		auto gm = GameManager::GetInstance();
		...
		if (m_CameraSelect == CameraSelect_Stage10::openingCamera)
		{
			...
			if (ptrPlayerCamera) {
				...
				m_CameraSelect = CameraSelect_Stage10::playerCamera;
			}
		}
	}

	void GameStage10::ToGoalCamera() {
		//GoalCameraに変更
		if (m_CameraSelect == CameraSelect_Stage10::myCamera)
		{
			...
			if (ptrGoalCamera) {
				...
				m_CameraSelect = CameraSelect_Stage10::goalCamera;
			}
		}
	}

	wstring GameStage10::GetCameraSelectName()
	{
		wstring camName = L"";
		if (m_CameraSelect == CameraSelect_Stage10::openingCamera)
		{
		...
		else if (m_CameraSelect == CameraSelect_Stage10::myCamera)
		{
			camName = L"MyCamera\n";
		}
		else if (m_CameraSelect == CameraSelect_Stage10::goalCamera)
		{
			camName = L"GoalCamera\n";
		}
		else if (m_CameraSelect == CameraSelect_Stage10::playerCamera)
		{

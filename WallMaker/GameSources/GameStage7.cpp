...
namespace basecross {
	...
	//	ゲームステージクラス実体
	//--------------------------------------------------------------------------------------
	void GameStage7::CreateViewLight()
	{
		...
		m_CameraSelect = CameraSelect_Stage7::openingCamera;
		//マルチライトの作成
	...
	void GameStage7::CreateWall()
	{
		...
		const int mapData[] =
		{
			...
			001,000,000,000,001,072, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48,  8,074,001,
			001,000,006,000,001,  8,000,042,000,000,000,000,042,003,000,000,000,000,000,000,000,000,046,001,
			001,000,000,000,001,044,046,001,044,000,000,046,001,044,000,042,000,000,000,005,000,000,046,001,
			001,000,000,000,001,044,000, 48,000,000,042,000, 48,000,046,001,044,000,000,000,042,000,046,001,
			001,000,000,000,  8,000,005,000,000,046,001,044,000,000,000, 48,000,003,000,046,001,044,046,001,
			001,000,000,000,  8,000,000,000,000,000, 48,000,  9,000,000,000,000,000,000,000, 48,000,046,001,
			001,000,000,000,  8,042,042,042,042,042,042,042,042,000,000,000,042,000,000,000,000,  9,046,001,
			001,001,001,001,001,001,001,001,001,001,001,001,001,044,000,046,001,044,000,000,000,000,046,001,
			001,047,  8,072,076,  8, 48, 48, 48, 48, 48, 48,  8,000,000,000, 48,000,000,000,000,000,046,001,
			001,044,000,  8,  8,000,000,000,000,000,042,000,  8,000,000,000,003,000,000,000,000,000,  8,001,
			001,044,000,000,042,000,000,000,003,046,001,044,  8,042,042,042,042,042,042,042,042,042, 78,001,
			001,044,000,046,001,044,000,000,000,000, 48,046,001,001,001,001,001,001,001,001,001,001,001,001,
			001,044,000,000, 48,003,000,000,000,000,000,046,001,076,  8, 48, 48, 48, 49,001,000,072,000,001,
			001,044,000,000,000,000,000,000,042,042,042,043,001,044,000,000,000,000,046,001,000,000,000,001,
			001,044,005,000,000,000,000,046,001,001,001,001,001,044,000,000,000,000,046,001,000,000,000,001,
			001,044,000,000,042,000,005,046,001,000,072,000,001,044,003,042,000,000,000,  8,000,000,000,001,
			001,044,000,046,001,044,000,046,001,000,000,000,001,044,046,001,044,000,000,  8,000,000,000,001,
			001,041,042,042, 48,000,000,046,001,000,000,000,001,044,000, 48,000,003,000,  8,000,000,000,001,
			001,001,001,001,044,000,000,046,001,  8,  8,  8,001,044,000,000,000,000,046,001,001,000,001,001,
			001,047, 48,  8,000,000,000,000, 48,000,000,046,001,044,000,000,000,000,046,001,000,000,000,001,
			001,076,000,  8,000,003,000,000,000,000,000,000,  8,000,000,000,000,000,046,001,000,002,000,001,
			001,041,042,  8,042,042,042,042,042,042,042,042,  8,042,042,042,042,  8,074,001,000,000,000,001,
			001,001,001,001,001,001,001,001,001,001,001,001,001,001,001,001,001,001,001,001,001,001,001,001,
		};
	...
	void GameStage7::DrawStrings()
	{

	}

	void GameStage7::OnCreate()
	{
		try {
			//ビューとライトの作成
			CreateViewLight();
	...
	void GameStage7::CreatePlayer(Vec3 pos)
	{
	...
	//カメラマンの作成
	void GameStage7::CreateCameraman()
	{
		// オープニングカメラを登録
	...
	void GameStage7::CreateClearButton()
	{
		auto gm = GameManager::GetInstance();
	...
	void GameStage7::CreateGameOverButton()
	{
		auto gm = GameManager::GetInstance();
	...
	void GameStage7::CreateSpriteAndButton()
	{
	...
	void GameStage7::SwitchPoseButton(bool poseFlg)
	{
		auto gm = GameManager::GetInstance();
	...
	void GameStage7::StopBGM()
	{
		auto ptrXA = App::GetApp()->GetXAudio2Manager();
		ptrXA->Stop(m_BGM);
	}

	void GameStage7::ChangeBGM(wstring bgmKey)
	{
	...
	void GameStage7::SetBgmName(wstring bgmName)
	{
		m_BgmName = bgmName;
	}

	wstring GameStage7::GetBgmName()
	{
		return m_BgmName;
	}

	void GameStage7::ToMyCamera() {
		auto gm = GameManager::GetInstance();

		//MyCameraに変更
		if (m_CameraSelect == CameraSelect_Stage7::openingCamera)
		{
			...
			if (ptrMyCamera) {
				...
				m_CameraSelect = CameraSelect_Stage7::myCamera;
			}
		}
	}

	void GameStage7::ToPlayerCamera() {
		auto gm = GameManager::GetInstance();
		...
		if (m_CameraSelect == CameraSelect_Stage7::openingCamera)
		{
			...
			if (ptrPlayerCamera) {
				...
				m_CameraSelect = CameraSelect_Stage7::playerCamera;
			}
		}
	}

	void GameStage7::ToGoalCamera() {
		//GoalCameraに変更
		if (m_CameraSelect == CameraSelect_Stage7::myCamera)
		{
			...
			if (ptrGoalCamera) {
				...
				m_CameraSelect = CameraSelect_Stage7::goalCamera;
			}
		}
	}

	wstring GameStage7::GetCameraSelectName()
	{
		wstring camName = L"";
		if (m_CameraSelect == CameraSelect_Stage7::openingCamera)
		{
		...
		else if (m_CameraSelect == CameraSelect_Stage7::myCamera)
		{
			camName = L"MyCamera\n";
		}
		else if (m_CameraSelect == CameraSelect_Stage7::goalCamera)
		{
			camName = L"GoalCamera\n";
		}
		else if (m_CameraSelect == CameraSelect_Stage7::playerCamera)
		{
